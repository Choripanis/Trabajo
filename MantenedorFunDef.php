...
<html>
	...
	<div class="contenedor">
        ...
        <tr>
         ...
         <tr>
         <td> cargo:    </td>
            <td>    <input type="radio" name="cargo" value = "Profesor" > Profesor  <input type="radio" name="cargo" value = "Inspector" > Inspector  <input type="radio" name="cargo" value = "Psicologo" > Psicologo </td>
         </tr>
         <td> clave:    </td>
...
<tr>
		...
		<tr>
			...
			||<a href="InformeFun.php">Informe PDF</a>||
</table>
</tr>
</table>	
...
<?php
	...
	$actualizarDatos = "UPDATE funcionario SET Rut='$rut',Nombre='$nombre',Apellido='$apellido',Telefono='$fono',Email='$email' , Cargo='$cargo',Clave='$clave' WHERE Rut='$ruta'";
